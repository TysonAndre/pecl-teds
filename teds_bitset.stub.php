...
final class BitSet implements \IteratorAggregate, Sequence, \JsonSerializable
{
    ...
    /** Creates a BitSet from a string generated by BitSet::serialize() */
    public static function unserialize(string $data): BitSet {}
    ...
    /**
     * Creates a BitSet from raw bytes.
     * The resulting bitset will have count($bitSet) === strlen($data) * 8.
     */
