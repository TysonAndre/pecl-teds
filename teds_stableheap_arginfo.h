 ...
 * Stub hash: d4c81f21d325c9c460b1304895e75a6bdfbff168 */
...
static zend_class_entry *register_class_Teds_StableMaxHeap(zend_class_entry *class_entry_Teds_SplMaxHeap)
{
	zend_class_entry ce, *class_entry;

	INIT_NS_CLASS_ENTRY(ce, "Teds", "StableMaxHeap", class_Teds_StableMaxHeap_methods);
	class_entry = zend_register_internal_class_ex(&ce, class_entry_Teds_SplMaxHeap);

	return class_entry;
}

static zend_class_entry *register_class_Teds_StableMinHeap(zend_class_entry *class_entry_Teds_SplMinHeap)
{
	zend_class_entry ce, *class_entry;

	INIT_NS_CLASS_ENTRY(ce, "Teds", "StableMinHeap", class_Teds_StableMinHeap_methods);
	class_entry = zend_register_internal_class_ex(&ce, class_entry_Teds_SplMinHeap);
