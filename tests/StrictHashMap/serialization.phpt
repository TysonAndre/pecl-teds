--TEST--
Teds\StrictHashMap can be serialized and unserialized
--FILE--
<?php

$it = new Teds\StrictHashMap(['first' => new stdClass()]);
try {
    $it->dynamicProp = 123;
} catch (Throwable $t) {
...
echo "Done\n";
$x = 123;
$it = Teds\StrictHashMap::fromPairs([[new stdClass(), &$x]]);
...
?>
--EXPECT--
Caught Error: Cannot create dynamic property Teds\StrictHashMap::$dynamicProp
