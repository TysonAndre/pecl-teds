--TEST--
Teds\StrictSortedVectorSet constructed from Traversable
--FILE--
<?php
...
// Teds\StrictSortedVectorSet eagerly evaluates the passed in Traversable
$it = new Teds\StrictSortedVectorSet(yields_values());
foreach ($it as $value) {
...
$emptyIt = new Teds\StrictSortedVectorSet(new ArrayObject());
var_dump($emptyIt);
