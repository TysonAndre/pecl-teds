...
// Teds\ImmutableKeyValueSequence eagerly evaluates the passed in Traversable
$it = new Teds\ImmutableKeyValueSequence(yields_values());
...
$emptyIt = new Teds\ImmutableKeyValueSequence(new ArrayObject());
var_dump($emptyIt);
