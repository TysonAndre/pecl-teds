--TEST--
Teds\ImmutableIterable constructed from Traversable
--FILE--
<?php
...
// Teds\ImmutableIterable eagerly evaluates the passed in Traversable
$it = new Teds\ImmutableIterable(yields_values());
...
$emptyIt = new Teds\ImmutableIterable(new ArrayObject());
var_dump($emptyIt);
