...
use function Teds\reduce;

/*
    Prototype: mixed Teds\reduce(array $array, callable($carry, $item): mixed $callback);
...
?>
--EXPECT--
Caught ArgumentCountError: Teds\reduce() expects at least 2 arguments, 1 given
string(4) "test"
string(7) "testxyz"
