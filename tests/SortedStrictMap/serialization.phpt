--TEST--
Teds\SortedStrictMap can be serialized and unserialized
--FILE--
<?php
...
echo "Done\n";
$x = 123;
$it = Teds\SortedStrictMap::fromPairs([[new stdClass(), &$x]]);
...
?>
--EXPECT--
Caught Error: Cannot create dynamic property Teds\SortedStrictMap::$dynamicProp
O:20:"Teds\SortedStrictMap":2:{i:0;s:5:"first";i:1;O:8:"stdClass":0:{}}
Entry:
string(5) "first"
object(stdClass)#5 (0) {
}
...
object(Teds\SortedStrictMap)#6 (1) {
  [0]=>
  array(2) {
    [0]=>
    object(stdClass)#4 (0) {
