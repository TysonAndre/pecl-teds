--TEST--
Teds\MutableIterable constructed from Traversable
--FILE--
<?php
...
// Teds\MutableIterable eagerly evaluates the passed in Traversable
$it = new Teds\MutableIterable(yields_values());
...
$emptyIt = new Teds\MutableIterable(new ArrayObject());
var_dump($emptyIt);
