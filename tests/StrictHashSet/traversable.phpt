--TEST--
Teds\StrictHashSet constructed from Traversable
--FILE--
<?php
...
// Teds\StrictHashSet eagerly evaluates the passed in Traversable
$it = new Teds\StrictHashSet(yields_values());
foreach ($it as $value) {
...
$emptyIt = new Teds\StrictHashSet(new ArrayObject());
var_dump($emptyIt);
