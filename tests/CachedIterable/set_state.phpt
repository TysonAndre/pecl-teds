--TEST--
Teds\CachedIterable::__set_state
--FILE--
<?php
...
dump_repr(Teds\CachedIterable::__set_state([]));
try {
    Teds\CachedIterable::__set_state(['first' => 'x']);
} catch (Throwable $e) {
    printf("Caught %s: %s\n", $e::class, $e->getMessage());
}
$it = Teds\CachedIterable::__set_state([['first', 'x'], [(object)['key' => 'value'], null]]);
