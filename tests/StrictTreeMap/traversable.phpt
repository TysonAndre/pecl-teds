--TEST--
Teds\StrictTreeMap constructed from Traversable
--FILE--
<?php
...
// Teds\StrictTreeMap eagerly evaluates the passed in Traversable
$it = new Teds\StrictTreeMap(yields_values());
...
$emptyIt = new Teds\StrictTreeMap(new ArrayObject());
var_dump($emptyIt);
