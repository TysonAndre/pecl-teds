--TEST--
Teds\StrictTreeMap can be serialized and unserialized
--FILE--
<?php
...
echo "Done\n";
$x = 123;
$it = Teds\StrictTreeMap::fromPairs([[new stdClass(), &$x]]);
...
?>
--EXPECT--
Caught Error: Cannot create dynamic property Teds\StrictTreeMap::$dynamicProp
