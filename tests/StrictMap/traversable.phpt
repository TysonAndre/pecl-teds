--TEST--
Teds\StrictMap constructed from Traversable
--FILE--
<?php
...
// Teds\StrictMap eagerly evaluates the passed in Traversable
$it = new Teds\StrictMap(yields_values());
...
$emptyIt = new Teds\StrictMap(new ArrayObject());
var_dump($emptyIt);
