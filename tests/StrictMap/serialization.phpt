--TEST--
Teds\StrictMap can be serialized and unserialized
--FILE--
<?php

$it = new Teds\StrictMap(['first' => new stdClass()]);
try {
    $it->dynamicProp = 123;
} catch (Throwable $t) {
...
echo "Done\n";
$x = 123;
$it = Teds\StrictMap::fromPairs([[new stdClass(), &$x]]);
...
?>
--EXPECT--
Caught Error: Cannot create dynamic property Teds\StrictMap::$dynamicProp
O:14:"Teds\StrictMap":2:{i:0;s:5:"first";i:1;O:8:"stdClass":0:{}}
Entry:
string(5) "first"
object(stdClass)#5 (0) {
}
