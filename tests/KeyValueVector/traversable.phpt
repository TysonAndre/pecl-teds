...
// Teds\KeyValueVector eagerly evaluates the passed in Traversable
$it = new Teds\KeyValueVector(yields_values());
...
$emptyIt = new Teds\KeyValueVector(new ArrayObject());
var_dump($emptyIt);
