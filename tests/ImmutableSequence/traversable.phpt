--TEST--
Teds\ImmutableSequence constructed from Traversable
--FILE--
<?php
...
// Teds\ImmutableSequence eagerly evaluates the passed in Traversable
$it = new Teds\ImmutableSequence(yields_values());
...
$emptyIt = new Teds\ImmutableSequence(new ArrayObject());
var_dump($emptyIt);
