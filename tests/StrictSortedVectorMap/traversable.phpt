--TEST--
Teds\StrictSortedVectorMap constructed from Traversable
--FILE--
<?php
...
// Teds\StrictSortedVectorMap eagerly evaluates the passed in Traversable
$it = new Teds\StrictSortedVectorMap(yields_values());
...
$emptyIt = new Teds\StrictSortedVectorMap(new ArrayObject());
var_dump($emptyIt);
