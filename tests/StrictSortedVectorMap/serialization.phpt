--TEST--
Teds\StrictSortedVectorMap can be serialized and unserialized
--FILE--
<?php
...
echo "Done\n";
$x = 123;
$it = Teds\StrictSortedVectorMap::fromPairs([[new stdClass(), &$x]]);
...
?>
--EXPECT--
Caught Error: Cannot create dynamic property Teds\StrictSortedVectorMap::$dynamicProp
...
object(Teds\StrictSortedVectorMap)#6 (1) {
  [0]=>
  array(2) {
    [0]=>
    object(stdClass)#4 (0) {
