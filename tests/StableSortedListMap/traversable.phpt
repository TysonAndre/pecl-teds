--TEST--
Teds\StableSortedListMap constructed from Traversable
--FILE--
<?php
...
// Teds\StableSortedListMap eagerly evaluates the passed in Traversable
$it = new Teds\StableSortedListMap(yields_values());
...
$emptyIt = new Teds\StableSortedListMap(new ArrayObject());
var_dump($emptyIt);
