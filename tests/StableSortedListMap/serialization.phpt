--TEST--
Teds\StableSortedListMap can be serialized and unserialized
--FILE--
<?php
...
echo "Done\n";
$x = 123;
$it = Teds\StableSortedListMap::fromPairs([[new stdClass(), &$x]]);
...
?>
--EXPECT--
Caught Error: Cannot create dynamic property Teds\StableSortedListMap::$dynamicProp
O:24:"Teds\StableSortedListMap":2:{i:0;s:5:"first";i:1;O:8:"stdClass":0:{}}
Entry:
string(5) "first"
object(stdClass)#5 (0) {
}
...
object(Teds\StableSortedListMap)#6 (1) {
  [0]=>
  array(2) {
    [0]=>
    object(stdClass)#4 (0) {
