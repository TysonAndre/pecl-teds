 ...
 */
final class SortedStrictMap implements \IteratorAggregate, Map, \JsonSerializable
{
    ...
    /**
     * Pops the [key, value] entry from the end of the SortedStrictMap.
     * @throws \UnderflowException if the SortedStrictMap is empty
     */
    public function pop(): array {}
    /**
     * Shifts the [key, value] entry from the front of the SortedStrictMap
     * @throws \UnderflowException if the SortedStrictMap is empty
     */
