 ...
 * Stub hash: 7ea8572d76d2405b81880c98e8fbe210f6662b89 */
...
#define arginfo_class_Teds_StrictSet_toArray arginfo_class_Teds_StrictSet___serialize
...
ZEND_METHOD(Teds_StrictSet, toArray);
...
static const zend_function_entry class_Teds_StrictSet_methods[] = {
	...
	ZEND_ME(Teds_StrictSet, toArray, arginfo_class_Teds_StrictSet_toArray, ZEND_ACC_PUBLIC)
...
static zend_class_entry *register_class_Teds_StrictSet(zend_class_entry *class_entry_IteratorAggregate, zend_class_entry *class_entry_Teds_Set, zend_class_entry *class_entry_JsonSerializable)
{
