 ...
 * Stub hash: 5ec95cca2bcf01ba66282fbdc359701aa53a1372 */
...
#define arginfo_class_Teds_SortedStrictSet_toArray arginfo_class_Teds_SortedStrictSet___serialize
...
ZEND_METHOD(Teds_SortedStrictSet, toArray);
...
static const zend_function_entry class_Teds_SortedStrictSet_methods[] = {
	...
	ZEND_ME(Teds_SortedStrictSet, toArray, arginfo_class_Teds_SortedStrictSet_toArray, ZEND_ACC_PUBLIC)
...
static zend_class_entry *register_class_Teds_SortedStrictSet(zend_class_entry *class_entry_IteratorAggregate, zend_class_entry *class_entry_Teds_Set, zend_class_entry *class_entry_JsonSerializable)
{
