...
function bench_unserialize_sorted_set(int $n, int $iterations) {
    ...
    for ($j = 0; $j < $iterations; $j++) {
        ...
        $values[rand() + 123] = 123;
        $values[rand() + 456] = 123;
        // SortedStrictMap stays sorted by keys
        $t4 = hrtime(true);
    ...
    printf("Unserializing sorted SortedStrictMap and reading single val: n=%8d iterations=%8d memory=%8d bytes, create+destroy time=%.3f read single time = %.3f add+sort=%.3f total=%.3f result=%d\n",
...
printf("(Note that SortedStrictMap unserialization is optimized for the case where inputs are already sorted, but there is still time+memory overhead to creating and destroying the individual nodes)\n");
...
(Note that SortedStrictMap unserialization is optimized for the case where inputs are already sorted, but there is still time+memory overhead to creating and destroying the individual nodes)
Unserializing sorted SortedStrictMap and reading single val: n=       1 iterations= 1000000 memory=     304 bytes, create+destroy time=2.129 read single time = 0.083 add+sort=0.150 total=2.363 result=1068724585000000
...
Unserializing sorted SortedStrictMap and reading single val: n=       4 iterations=  400000 memory=     544 bytes, create+destroy time=0.971 read single time = 0.037 add+sort=0.061 total=1.069 result=427489834000000
...
Unserializing sorted SortedStrictMap and reading single val: n=       8 iterations=  200000 memory=     864 bytes, create+destroy time=0.589 read single time = 0.020 add+sort=0.034 total=0.643 result=213744917000000
...
Unserializing sorted SortedStrictMap and reading single val: n=    1024 iterations=    1000 memory=   82144 bytes, create+destroy time=0.117 read single time = 0.000 add+sort=0.000 total=0.118 result=1068724585000
...
Unserializing sorted SortedStrictMap and reading single val: n=  262144 iterations=      20 memory=20970064 bytes, create+destroy time=1.536 read single time = 0.000 add+sort=0.000 total=1.536 result=21374491700
