...
PHP_MINIT_FUNCTION(teds_emptysequence)
{
	...
	memcpy(&teds_handler_EmptySequence, &std_object_handlers, sizeof(zend_object_handlers));
	...
	memcpy(&teds_handler_EmptySet, &std_object_handlers, sizeof(zend_object_handlers));
