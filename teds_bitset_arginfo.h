...
#define arginfo_class_Teds_BitSet_first arginfo_class_Teds_BitSet_isEmpty

#define arginfo_class_Teds_BitSet_last arginfo_class_Teds_BitSet_isEmpty
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_class_Teds_BitSet_clear, 0, 0, IS_VOID, 0)
ZEND_END_ARG_INFO()
...
static const zend_function_entry class_Teds_BitSet_methods[] = {
	...
	ZEND_ME(Teds_BitSet, clear, arginfo_class_Teds_BitSet_clear, ZEND_ACC_PUBLIC)
